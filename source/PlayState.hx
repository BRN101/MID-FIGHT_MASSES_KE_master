...
class PlayState extends MusicBeatState
{
	...
	public var sarvTrail:FlxTrail; //si no funciona quitalo
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'parish':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/parish/parishDialogue'));
			case 'worship':
			...
			case 'casanova':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/casanova/casanovaDialogue'));
		}
				...
				case 'church1':
					{
						defaultCamZoom = 0.9;
						curStage = 'church1';
						var bg:FlxSprite = new FlxSprite(-240, -630).loadGraphic(Paths.image('church1/bg'));
						bg.antialiasing = true;
						bg.active = false;
						add(bg);
		
						var stageFront:FlxSprite = new FlxSprite(-240, -630).loadGraphic(Paths.image('church1/floor'));
						stageFront.updateHitbox();
						stageFront.antialiasing = true;
						stageFront.active = false;
						add(stageFront);
			
						var stageCurtains:FlxSprite = new FlxSprite(-240, -630).loadGraphic(Paths.image('church1/pillars'));
				...
				case 'church2':
					{
						defaultCamZoom = 0.9;
						curStage = 'church2';
						var bg:FlxSprite = new FlxSprite(-265, -630).loadGraphic(Paths.image('church2/bg-dark'));
						bg.antialiasing = true;
						bg.active = false;
						add(bg);
			
						var stageFront:FlxSprite = new FlxSprite(-265, -630).loadGraphic(Paths.image('church2/floor-dark'));
						stageFront.updateHitbox();
						stageFront.antialiasing = true;
						stageFront.active = false;
						add(stageFront);
			
						var stageCurtains:FlxSprite = new FlxSprite(-265, -630).loadGraphic(Paths.image('church2/pillars-dark'));
						stageCurtains.updateHitbox();
						stageCurtains.antialiasing = true;
						stageCurtains.active = false;
				...
				case 'church3':
					{
						defaultCamZoom = 0.9;
						curStage = 'church3';
						var bg:FlxSprite = new FlxSprite(-240, -630).loadGraphic(Paths.image('church3/bg'));
						bg.antialiasing = true;
						bg.active = false;
						add(bg);
			
						var stageFront:FlxSprite = new FlxSprite(-240, -630).loadGraphic(Paths.image('church3/floor'));
						stageFront.updateHitbox();
						stageFront.antialiasing = true;
						stageFront.active = false;
						add(stageFront);
			
						var stageCurtains:FlxSprite = new FlxSprite(-240, -630).loadGraphic(Paths.image('church3/271'));
						stageCurtains.updateHitbox();
						stageCurtains.antialiasing = true;
						stageCurtains.active = false;
						...
						pillar = new FlxSprite(-240, -630).loadGraphic(Paths.image('church3/pillarbroke'));
						pillar.updateHitbox();
				...
				case 'church4':
					{
						defaultCamZoom = 0.9;
						curStage = 'church4';
						var bg:FlxSprite = new FlxSprite(-240, -630).loadGraphic(Paths.image('church4/bg'));
						bg.antialiasing = true;
						bg.active = false;
						add(bg);
			
						var stageFront:FlxSprite = new FlxSprite(-240, -630).loadGraphic(Paths.image('church4/floor'));
						stageFront.updateHitbox();
						stageFront.antialiasing = true;
						stageFront.active = false;
						add(stageFront);
			
						var stageCurtains:FlxSprite = new FlxSprite(-240, -630).loadGraphic(Paths.image('church4/pillars'));
						stageCurtains.updateHitbox();
						stageCurtains.antialiasing = true;
						stageCurtains.active = false;
						...
						var stageCurtains:FlxSprite = new FlxSprite(-240, -630).loadGraphic(Paths.image('church4/circ0'));
						stageCurtains.updateHitbox();
						stageCurtains.antialiasing = true;
						stageCurtains.active = false;
						...
						var stageCurtains:FlxSprite = new FlxSprite(-240, -630).loadGraphic(Paths.image('church4/circ1'));
						stageCurtains.updateHitbox();
						stageCurtains.antialiasing = true;
						stageCurtains.active = false;
						...
						var stageCurtains:FlxSprite = new FlxSprite(-240, -630).loadGraphic(Paths.image('church4/circ2'));
						stageCurtains.updateHitbox();
						stageCurtains.antialiasing = true;
						stageCurtains.active = false;
					...
					case 'churchselever':
					{
						...
						var bg:FlxSprite = new FlxSprite(-265, -630).loadGraphic(Paths.image('churchselever/bg'));
						bg.antialiasing = true;
						bg.active = false;
						add(bg);
			
						var stageFront:FlxSprite = new FlxSprite(-265, -630).loadGraphic(Paths.image('churchselever/floor'));
						stageFront.updateHitbox();
						stageFront.antialiasing = true;
						stageFront.active = false;
						add(stageFront);
			
						var stageCurtains:FlxSprite = new FlxSprite(-265, -630).loadGraphic(Paths.image('churchselever/pillars'));
						stageCurtains.updateHitbox();
						stageCurtains.antialiasing = true;
						stageCurtains.active = false;
				...
				if (FlxG.save.data.distractions)
					{
						if (!PlayStateChangeables.Optimize)
						{
							sarvTrail = new FlxTrail(dad, null, 4, 24, 0.3, 0.069);
							sarvTrail.color = 0xFFA9038C;
						}
					}
		...
		switch (dad.curCharacter)
        {
			...
			case 'sarvente'| 'sarvente-dark' :
			  healthBar.createFilledBar(0xFFF691C5, 0xFF0097C4);
			case 'ruv':
			  healthBar.createFilledBar(0xFF978AA6, 0xFF0097C4);
			case 'sarvente-lucifer':
			  healthBar.createFilledBar(0xFFDA317D, 0xFF0097C4);
			case 'selever':
			  healthBar.createFilledBar(0xFF972651, 0xFF0097C4);
        }
		// healthBar
		add(healthBar);
	...
	function gospelIntro(?dialogueBox:DialogueBox):Void
	{
		...
		sarvEvil.frames = Paths.getSparrowAtlas('church4/pegMePlease');
	...
	override function stepHit()
	{
		...
		if (dad.curCharacter == 'sarvente' && SONG.song.toLowerCase() == 'parish')
		{
			switch (curStep)
			{
				case 387:
		...
		if (dad.curCharacter == 'sarvente-dark' && SONG.song.toLowerCase() == 'worship')
		{
			switch (curStep)
			{
				case 515 | 643:
		...
		if (dad.curCharacter == 'ruv' && SONG.song.toLowerCase() == 'zavodila')
		{
			switch (curStep)
			{
				case 131 | 655 | 1047:
		...
		if (dad.curCharacter == 'sarvente-lucifer' && SONG.song.toLowerCase() == 'gospel')
		{
			switch (curStep)
			{
				case 128 | 576 | 1153:
		...
		if (dad.curCharacter == 'selever' && SONG.song.toLowerCase() == 'casanova')
		{
			switch (curStep)
			{
				case 129 | 385 | 448 | 768:
					add(sarvTrail);
				case 192 | 416 | 480 | 832:
					remove(sarvTrail);
			}
		}
